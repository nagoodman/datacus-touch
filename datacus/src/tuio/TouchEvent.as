package tuio {
	...
	public class TouchEvent extends Event {
		...
		public static const TOUCH_DOWN:String = "tuio.TouchEvent.TOUCH_DOWN";
		/**Triggered if a touch is released.*/
		public static const TOUCH_UP:String = "tuio.TouchEvent.TOUCH_UP";
		/**Triggered if a touch is moved.*/
		public static const TOUCH_MOVE:String = "tuio.TouchEvent.TOUCH_MOVE";
		/**Triggered if a touch is moved out of a DisplayObject.*/
		public static const TOUCH_OUT:String = "tuio.TouchEvent.TOUCH_OUT";
		/**Triggered if a touch is moved over a DisplayObject.*/
		public static const TOUCH_OVER:String = "tuio.TouchEvent.TOUCH_OVER";
		/**Triggered if a touch is moved out of a DisplayObject.*/
		public static const ROLL_OUT:String = "tuio.TouchEvent.ROLL_OUT";
		/**Triggered if a touch is moved over a DisplayObject.*/
		public static const ROLL_OVER:String = "tuio.TouchEvent.ROLL_OVER";
		
		/**Triggered if a TOUCH_DOWN and TOUCH_UP occurred over the same DisplayObject.*/
		public static const TAP:String = "tuio.TouchEvent.TAP";
		/**Triggered if two subsequent TABs occurred over the same DisplayObject.*/
		public static const DOUBLE_TAP:String = "tuio.TouchEvent.DOUBLE_TAP";
		
		/**Triggered if a touch is held for a certain time over the same DisplayObject without movement.*/
		public static const HOLD:String = "tuio.TouchEvent.HOLD";
