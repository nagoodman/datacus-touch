package tuio.debug
{
	...
	public class TuioDebug implements ITuioListener{
		...
		private function addCursorEventListeners(cursor:TuioDebugCursor):void{
			cursor.addEventListener(tuio.TouchEvent.TAP, propagateEvent);
			cursor.addEventListener(tuio.TouchEvent.DOUBLE_TAP, propagateEvent);
			cursor.addEventListener(tuio.TouchEvent.TOUCH_DOWN, propagateEvent);
			cursor.addEventListener(tuio.TouchEvent.TOUCH_MOVE, propagateEvent);
			cursor.addEventListener(tuio.TouchEvent.TOUCH_OUT, propagateEvent);
			cursor.addEventListener(tuio.TouchEvent.TOUCH_OVER, propagateEvent);
			cursor.addEventListener(tuio.TouchEvent.TOUCH_UP, propagateEvent);
			cursor.addEventListener(tuio.TouchEvent.ROLL_OUT, propagateEvent);
			cursor.addEventListener(tuio.TouchEvent.ROLL_OVER, propagateEvent);
		}
		
		private function propagateEvent(event:tuio.TouchEvent):void{
